...
// --- Hook para detectar el dispositivo móvil ---
const useIsMobile = () => {
...
function AcercaDePageDesktop() {
  ...
  return (
    <div ref={containerRef} className="relative h-[1200vh]">
      ...
      {/* Filtro claro de fondo para asegurar legibilidad */}
      <div className="fixed inset-0 bg-white/20 z-0 transition-colors duration-300"></div>

      <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden z-10">
        <div className="relative w-full max-w-6xl h-[80vh]">
          
          <motion.div style={{ opacity: opacity1, y: y1, scale: scale1 }} className="absolute inset-0 bg-white/85 backdrop-blur-md shadow-2xl rounded-2xl p-8 flex flex-row items-start justify-between border border-white/25 transition-colors duration-300">
            <div className="flex-grow text-gray-700 text-justify pr-8 overflow-y-auto max-h-[70vh] no-scrollbar">
              <h2 className="text-3xl font-bold mb-6 text-teal-800">Sobre la UNAM</h2>
              ...
              <h2 className="text-2xl font-bold mb-4 mt-6 text-teal-800">VISION</h2>
              ...
              <p className="mb-4">El State constitucional es unitario y descentralizado. Su accionar es ético, transparente, eficaz, eficiente, moderno y con enfoque intercultural. </p>
              ...
              <h2 className="text-2xl font-bold mb-4 mt-6 text-teal-800">MISION</h2>
            ...
            <div className="w-[250px] flex-shrink-0 flex items-center justify-center p-4">
              <Image src="/logo-unam.png" alt="Logo UNAM" width={220} height={220} className="object-contain" />
            </div>
          </motion.div>

          <motion.div style={{ opacity: opacity2, y: y2, scale: scale2 }} className="absolute inset-0 bg-white/85 backdrop-blur-md shadow-2xl rounded-2xl p-8 flex flex-row-reverse items-start justify-between border border-white/25 transition-colors duration-300">
            <div className="flex-grow text-gray-700 text-justify pl-8 overflow-y-auto max-h-[70vh] no-scrollbar">
              <h2 className="text-3xl font-bold mb-6 text-teal-800">Sobre la biblioteca</h2>
            ...
            <div className="w-[280px] flex-shrink-0 flex items-center justify-center p-4">
              <Image src="/logo-biblioteca.png" alt="Logo Biblioteca" width={250} height={250} className="object-contain" />
            </div>
          </motion.div>

          <motion.div style={{ opacity: opacity3, y: y3, scale: scale3 }} className="absolute left-1/2 top-[40%] -translate-x-1/2 -translate-y-1/2 w-full max-w-xl">
            <div className="bg-white/80 backdrop-blur-md px-6 py-8 text-center rounded-2xl shadow-xl border border-white/20 transition-colors duration-300">
              <h2 className="text-2xl md:text-3xl font-extrabold text-[#001f3f] drop-shadow-md mb-6">Página diseñada por:</h2>
              <div className="text-gray-800 text-lg font-semibold space-y-2.5">
                <p className="hover:text-teal-600 transition-colors">D&apos;anyelo Alessandro Segovia Bernedo</p>
                <p className="hover:text-teal-600 transition-colors">Geancarlo Alberto Quispe Aguilar</p>
                <p className="hover:text-teal-600 transition-colors">JeanPiere Cristhian Calizaya Mamani</p>
                <p className="hover:text-teal-600 transition-colors">Diego Hubert Peñaloza Cerrato</p>
              </div>
            </div>
          </motion.div>

          <motion.div style={{ opacity: opacity4, y: y4, rotate: rotate4 }} className="absolute inset-x-0 top-[78%] mx-auto w-full max-w-xl bg-white/95 backdrop-blur-md px-8 py-4 rounded-xl shadow-lg text-center border border-white/50 transition-all duration-300">
            <p className="text-[#001f3f] font-extrabold text-lg">Curso: Gestion de proyectos II</p>
          </motion.div>
        </div>
      </div>
    </div>
...
function AcercaDePageMobile() {
      ...
      content: (
        <>
          ...
          <div className="text-gray-700 text-justify">
            ...
            <p className="text-sm mb-4">El 10 de julio del 2007, mediante Resolución Nro. 204-2007-CONAFU, se aprueba el Proyecto de Desarrollo Institucional de la Universidad Nacional de Moquegua, presentado por la Promotora Ministerio de Educación y mediante el cual se considera iniciar el funcionamiento de nuestra institución con las carreras profesionales de Ingeniería Pesquera, Ingeniería de Sistemas e Informática e Ingeniería Ambiental en la sede de Ilo; además de Gestión Pública y Desarrollo Social, Ingeniería Agroindustrial e Ingeniería de Minas, en la sede de Mariscal Nieto.</p>
            <h3 className="text-base font-bold mb-2 text-teal-800">VISION</h3>
            ...
            <h3 className="text-base font-bold mb-2 text-teal-800">MISION</h3>
      ...
      content: (
        <>
          <div className="w-[180px] mb-6">
            <Image src="/logo-biblioteca.png" alt="Logo Biblioteca" width={180} height={180} className="object-contain" />
          </div>
          <div className="text-gray-700 text-justify">
            <p className="text-sm mb-4">Este trabajo fue implementado en julio de 2025, en la sede de Ilo, como una iniciativa estudiantil que busca aportar al desarrollo institucional y académico de la universidad, permitiendo a los estudiantes y docentes acceder a material bibliográfico, revistas, colecciones digitales y recursos educativos en línea de forma centralizada y accesible.</p>
            <h3 className="text-base font-bold mb-2 text-teal-800">VISION</h3>
      ...
      content: (
        <>
          <div className="text-center mb-6">
            <h2 className="text-base font-bold text-gray-800 mb-4">Página diseñada por:</h2>
            <div className="text-gray-700 text-sm font-semibold space-y-1.5">
              <p>D&apos;anyelo Alessandro Segovia Bernedo</p>
              <p>Geancarlo Alberto Quispe Aguilar</p>
              <p>JeanPiere Cristhian Calizaya Mamani</p>
              <p>Diego Hubert Peñaloza Cerrato</p>
            </div>
          </div>
          <div className="w-full max-w-sm bg-white/95 p-4 rounded-xl shadow-inner text-center border border-gray-200">
            <p className="text-[#001f3f] font-bold text-sm">Curso: Gestion de proyectos II</p>
          </div>
        </>
      ),
    },
  ...
  return (
    <div className="w-full min-h-screen p-4 space-y-4 bg-slate-50 transition-colors duration-300">
      {sections.map((section, index) => {
        const isExpanded = expandedIndex === index
        return (
          <div key={index} className="bg-white rounded-xl shadow-md overflow-hidden border border-slate-100 transition-colors duration-300">
            <motion.header
            ...
            <AnimatePresence initial={false}>
              {isExpanded && (
                <motion.section
                  ...
                  style={{
                    backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.88), rgba(255, 255, 255, 0.88)), url(${section.background})`,
